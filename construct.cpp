...
void build_shp_undirect_graph(const char *graphFileName,const char * labelFileName,const char * output){
    ...
    Coverage_Ordering_Path coverage_ordering(wgraph, true);
...
void build_shp_direct_graph(const char *graphFileName,const char * labelFileName,const char * output)
{
    DIRECTED_FLAG = true;
    WGraph wgraph;
    wgraph.load_graph(graphFileName);
...
int main(int argc, char *argv[]) {
    ...
    build_shp_direct_graph(argv[1],argv[2],argv[3]);
